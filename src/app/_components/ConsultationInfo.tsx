      ...
      <section id="consultationInfo" className="bg-slate-50 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center relative">
            ...
            <div className="flex flex-col items-center text-center w-full md:w-1/5 mb-8 md:mb-0 bg-slate-50 relative">
              <div className="w-8 h-8 rounded-full bg-slate-800 text-white flex items-center justify-center font-bold text-sm mb-4">
                1
              </div>
            ...
            <div className="flex flex-col items-center text-center w-full md:w-1/5 bg-slate-50 relative">
              <div className="w-8 h-8 rounded-full bg-slate-800 text-white flex items-center justify-center font-bold text-sm mb-4">
                5
              </div>
              <div className="text-teal-600 mb-2">
